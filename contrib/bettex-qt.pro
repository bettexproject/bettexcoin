...
RESOURCES += src/qt/bettex.qrc src/qt/bettex_locale.qrc

TRANSLATIONS += src/qt/locale/bettex_bg.ts \
                src/qt/locale/bettex_de.ts \
                src/qt/locale/bettex_en.ts \
                src/qt/locale/bettex_es.ts \
                src/qt/locale/bettex_fi.ts \
                src/qt/locale/bettex_fr.ts \
                src/qt/locale/bettex_it.ts \
                src/qt/locale/bettex_ja.ts \
                src/qt/locale/bettex_pl.ts \
                src/qt/locale/bettex_pt.ts \
                src/qt/locale/bettex_ru.ts \
                src/qt/locale/bettex_sk.ts \
                src/qt/locale/bettex_sv.ts \
                src/qt/locale/bettex_vi.ts \
                src/qt/locale/bettex_zh_CN.ts \
                src/qt/locale/bettex_zh_TW.ts
