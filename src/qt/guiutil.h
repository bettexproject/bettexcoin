...
/** Utility functions used by the Bettex Qt UI.
 */
namespace GUIUtil
{
...
// Render Bettex addresses in monospace font
...
// Parse "bettex:" URI into recipient object, return true on successful parsing
