                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Bettex Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bettex address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bettex: URIs)"));
    ...
    //privacyAction->setStatusTip(tr("Privacy Actions for zBTXC"));
...
//#endif
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Bettex Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bettex Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bettex"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bettex addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bettex addresses"));
    ...
    //multisigSpendAction = new QAction(QIcon(":/icons/address-book"), tr("&Multisignature spending..."), this);
    ...
    openAction->setStatusTip(tr("Open a Bettex: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bettex Core help message to get a list with possible Bettex command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Bettex Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bettex network", "", count));
}
...
{
    QString strTitle = tr("Bettex Core"); // default title
