...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Bettex to zBettex");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zBettex");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Bettex from zBettex");
    case TransactionRecord::ZerocoinSpend_Change_zBettex:
        return tr("Minted Change as zBettex from zBettex Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zBettex to Bettex");
