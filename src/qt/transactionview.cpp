                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Bettex from zBettex"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBettex"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBettex));
