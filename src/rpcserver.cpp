...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bettex features */
        {"bettex", "masternode", &masternode, true, true, false},
        {"bettex", "listmasternodes", &listmasternodes, true, true, false},
        {"bettex", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bettex", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bettex", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bettex", "masternodedebug", &masternodedebug, true, true, false},
        {"bettex", "startmasternode", &startmasternode, true, true, false},
        {"bettex", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bettex", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bettex", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bettex", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bettex", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bettex", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bettex", "mnbudget", &mnbudget, true, true, false},
        {"bettex", "preparebudget", &preparebudget, true, true, false},
        {"bettex", "submitbudget", &submitbudget, true, true, false},
        {"bettex", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bettex", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bettex", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bettex", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bettex", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bettex", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bettex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bettex", "checkbudgets", &checkbudgets, true, true, false},
        {"bettex", "mnsync", &mnsync, true, true, false},
        {"bettex", "spork", &spork, true, true, false},
        {"bettex", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bettex", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bettexd, or the -server option to bettex-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bettex-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:31471/\n";
}
