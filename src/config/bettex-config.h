/* src/config/bettex-config.h.  Generated from bettex-config.h.in by configure.  */
/* src/config/bettex-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BETTEX_CONFIG_H

#define BETTEX_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.bettex.bet"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bettex Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bettex Core 2.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bettex"
