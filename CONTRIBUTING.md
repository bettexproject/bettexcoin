Contributing to Bettex Core
============================

The Bettex Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bettex Core project, and is not to be
confused with overall Bettex Network Protocol consensus changes.

Whether a pull request is merged into Bettex Core rests with the project merge
...
Patches that change Bettex consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bettex consensus, it must have been
...
The project leader is the release manager for each Bettex Core release.
