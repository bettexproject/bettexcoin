...
In order to support loading of multiple wallets in bettex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bettex.cpp.
...
Changes to bettex.cpp
----------------------
bettex.cpp is the entry point into bettex-qt, and as such, will require some minor modifications to provide hooks for
